...
/* Add a custom payment class to woocommerce
 ...
 define('SAPHALI_LITE_VERSION', '1.5.1' );
...
function _print_script_columns() {
		...
		?>
	<style type="text/css">
		@font-face { font-family: "Arial Narrow"; src: url(http://www.artlebedev.ru/;-)/ruble.eot); }
		span.rur { font-family: "Arial Narrow"; text-transform: uppercase; // text-transform: none;}    
